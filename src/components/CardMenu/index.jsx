...
export default function index(props) {
    ...
    return (
        <div className=' relative w-[85%] sm:w-[50%] md:w-[30%] mt-8 shadow-lg hover:scale-105 transition-all duration-300' onMouseOver={handleMouseIn} onMouseOut={handleMouseOut}>
