...
export default function index() {
    ...
    return (
        <section id='about' className='w-full px-[1rem] md:px-[8rem] font-crimson bg-brown2  py-16'>
            <div className='flex flex-col md:flex-row items-center'>
                ...
                <div data-aos="fade-up" className='flex-[1] text-center md:text-left px-[20px] md:pr-[10px] md:pl-0'>
                    <h2 className='text-white font-[600] leading-[55px] text-5xl md:text-6xl'>Tentang Soto Pak Wito</h2>
                    <hr className='mt-6 mb-10 md:mt-4 md:mb-8 mx-auto md:mx-0 w-[90%] md:w-full border-[2px] border-brown3' />
                    <p className=' text-brown4 text-xl sm:text-2xl text-justify'>
